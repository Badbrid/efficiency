<template>
    <el-dialog title="添加代理配置" :visible.sync="dialogFormVisible">
        <el-form :model="form" :rules="rule" ref="createProxyForm">
            <el-form-item label="接口地址" :label-width="formLabelWidth" prop="sourceUrl">
                <el-input v-model="form.sourceUrl" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="目标地址" :label-width="formLabelWidth" prop="targetUrl">
            ...
            <el-form-item label="是否自定义请求" :label-width="formLabelWidth" prop="requestParams">
                <el-input v-model="form.requestParams" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="是否自定义响应" :label-width="formLabelWidth" prop="responseResult">
                <el-input v-model="form.responseResult" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="自定义请求" :label-width="formLabelWidth" prop="reqParams">
                <el-input v-model="form.reqParams" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="自定义响应" :label-width="formLabelWidth" prop="respResult">
   ...
   created() {
       if(this.$options.options) {
           if(this.$options.options.data){
               if(this.$options.options.data.row){
